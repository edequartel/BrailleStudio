...
<head>
  ...
  <link rel="stylesheet" href="<?= $htmlUrl($urlFor($appBase, 'components/braillebridge-status/braillebridge-status.css?v=20260706-popup-text-2')) ?>">
  <style>
...
<body class="bg-body">
  ...
  <script src="<?= $htmlUrl($urlFor($appBase, 'components/braillebridge-status/braillebridge-status.js?v=20260706-popup-text-2')) ?>"></script>
  <script>
    (function () {
